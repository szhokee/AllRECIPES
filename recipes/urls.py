...
from .views import CuisineModelViewSet, IngredientModelViewSet, DishModelViewSet, FavoriteModelViewSet, CommentModelViewSet , GeneratorModelViewSet

router = DefaultRouter()
router.register('', CuisineModelViewSet)
router.register('', IngredientModelViewSet)
router.register('', DishModelViewSet)
router.register('', GeneratorModelViewSet)
...
urlpatterns = [
    ...
    path('generator/', include(router.urls)),
